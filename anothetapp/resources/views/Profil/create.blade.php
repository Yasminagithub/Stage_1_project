                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Prenom" class="form-control" placeholder="Tapez Prenom" value="{{old('Prenom')}}" />
                            </div>
                            <span style="color:red">
                                @error('Prenom')
                                    {{$message}}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="Email" class="form-control" placeholder="Tapez Email"  value="{{old('Email')}}">
                            </div>
