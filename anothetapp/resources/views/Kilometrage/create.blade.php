    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('Kilometrage.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            <h4>Kilometrage</h4>
                            <div class="mb-3">
                        ...
                        <input type="text" id="searchFilter" name="searchFilter" class="form-control" placeholder="Recherche...." onkeyup="filterItems(this);">
                                ...
                                <select id="ddVehicles" name="transport_id" class="form-control" >
                                    @foreach($transports as $item)
                                        <option value="{{$item->id}}">{{$item->Immatriculation}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                <label>Kilometrage (Km)<span style="color:red">*</span></label>
                                <input type="number" name="Kilometrage" step="0.01" class="form-control" placeholder="Tapez le Kilometrage" value="{{old('Kilometrage')}}"/>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_Kilometrage"  class="form-control" placeholder="Tapez la Date de Kilometrage" value="{{old('Date_Kilometrage')}}"/>
                                    <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" name="Heure_Kilo"  class="form-control" placeholder="Tapez l'heure de Kilometrage" value="{{old('Heure_Kilo')}}"/>
                                <span style="color:red">
                                    @error('Heure_Kilo')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Commentaire_Kilometrage"  class="form-control" placeholder="Tapez Commentaire de Kilometrage" value="{{old('Commentaire_Kilometrage')}}"/>
                                    <span style="color:red">
