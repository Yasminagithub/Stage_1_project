    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('Renumeration.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select name="Type_renumeration" class="form-select form-control @error('gender') is-invalid @enderror" aria-label=".form-select-lg example" value="{{old('Type_renumeration')}}">
                                    <option value="" selected>Choisir le type de rémunération</option>
                                    <option value="Salaire" @if (old('Type_renumeration') == "Salaire") {{ 'selected' }}@endif>Salaire</option>
                                    <option value="Prime" @if (old('Type_renumeration') == "Prime") {{ 'selected' }}@endif>Prime</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="Valeur_renumeration" min="1" max="10000" step="0.01" class="form-control" placeholder="Tapez la Valeur de renumeration" value="{{old('Valeur_renumeration')}}"/>
                                    <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_renumeration"  class="form-control" placeholder="Tapez la Date de renumeration" value="{{old('Date_renumeration')}}"/>
                                    <span style="color:red">
