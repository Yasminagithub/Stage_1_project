                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Numero_Bancaire" class="form-control" value="{{$fournisseur->Numero_Bancaire}}" />
                            </div>

                            <div class="mb-3">
                                <label for="phone">Téléphone<span style="color:red">*</span></label>
                                <input type="tel" id="phone" name="Telephone" class="form-control" pattern="[0-9]{4}[0-9]{6}" value="{{$fournisseur->Telephone}}">
                            </div>
                            <span style="color:red">
                                @error('Telephone')
                                    {{$message}}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Description"  class="form-control" value="{{$fournisseur->Description}}"/>
                            </div>
                            <span style="color:red">
                                @error('Description')
                                    {{$message}}
