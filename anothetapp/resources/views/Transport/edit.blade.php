                        ...
                        <input type="text" id="searchFilter" name="searchFilter" class="form-control" placeholder="Recherche...." onkeyup="filterItems(this);">
                                ...
                                <select id="ddVehicles" name="employe_id" class="form-control" >
                                    @foreach($employes as $item)
                                        <option value="{{$item->id}}" {{$transport->employe->id == $item->id ? 'selected':''}}>{{$item->Nom_employe}} {{$item->Prenom_employe}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Immatriculation"  class="form-control" value="{{ $transport->Immatriculation }}"/>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Marque" class="form-control" value="{{ $transport->Marque }}" />
                            </div>
                            <span style="color:red">
                                @error('Marque')
                                    {{$message}}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_fin_Vignette" class="form-control" value="{{ $transport->Date_fin_Vignette }}" />
                            </div>
                            <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_Visite_Assurance_Debut" class="form-control" value="{{ $transport->Date_Visite_Assurance_Debut }}" />
                            </div>
                            <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_Visite_Assurance_Fin" class="form-control" value="{{ $transport->Date_Visite_Assurance_Fin }}"/>
                            </div>
                            <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_Visite_technique_Fin" class="form-control"  value="{{ $transport->Date_Visite_technique_Fin }}" />
                            </div>
                            <span style="color:red">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="Date_Visite_equipement_Fin" class="form-control" value="{{ $transport->Date_Visite_equipement_Fin }}" />
                            </div>
                            <span style="color:red">
