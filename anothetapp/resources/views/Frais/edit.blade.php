                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select id="ddVehicles" name="etudiant_id" class="form-control" >
                                    @foreach($etudiants as $item)
                                        <option value="{{$item->id}}" {{ $frais->etudiant->id == $item->id ? 'selected':''}}>{{$item->Nom_Etudiant}} {{$item->Prenom_Etudiant}}</option>
                                        @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                <label>Montant de paiement<span style="color:red">*</span></label>
                                <input type="number" min="1" max="5000" step="0.01" name="MontantPaiement"  class="form-control" value="{{ $frais->MontantPaiement }}"/>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="DatePaiement"  class="form-control" value="{{ $frais->DatePaiement }}"/>
                                    <span style="color:red">
                                        @error('DatePaiement')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="DateFrom"  class="form-control" value="{{ $frais->DateFrom }}"/>
                                    <span style="color:red">
                                        @error('DateFrom')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="DateTo"  class="form-control" value="{{ $frais->DateTo }}"/>
                                    <span style="color:red">
                                        @error('DateTo')
                                            {{$message}}
                                        @enderror
